		...
		<div class="row m-0">
			<div class="col-12 col-md-2 m-0 bg-light py-4">
				<div class="d-flex flex-column gap-2">
					...
					<a class="border-bottom text-decoration-none py-2" href="/kriteria.php">Kriteria</a>
					<a class="border-bottom text-decoration-none py-2" href="/alternatif.php">Alternatif</a>
				</div>
			</div>
